...
if __name__ == "__main__":
    ...
    isochrone_left = iso.construct_isochrone_branch_left_from_point(v_lc0, a_lc0, vres, vmin, insert_point = 0)
    isochrone_right = iso.construct_isochrone_branch_right_from_point(v_lc0, a_lc0, vmax)
    branch1 = isochrone_left[:-1] + isochrone_right

    v_ub0, a_ub0 = iso.start_point_upper_branch
    v_lb0, a_lb0 = iso.start_point_lower_branch
    print(v_lb0, a_lb0)
    l = iso.get_isochrone()
    isochrone_left = iso.construct_isochrone_branch_left_from_point(v_ub0, a_ub0, vres, vmin, insert_point = len(l))
    isochrone_right = iso.construct_isochrone_branch_right_from_point(v_ub0, a_ub0, vmax)

    sochrone_left = iso.construct_isochrone_branch_left_from_point(v_lb0, a_lb0, vres, 0, insert_point=0)
    print(iso.start_point_upper_branch)
    print(iso.start_point_lower_branch)
