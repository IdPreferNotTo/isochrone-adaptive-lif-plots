...
if __name__ == "__main__":
    ...
    isochrone = np.loadtxt(home + "/CLionProjects/PhD/alif_deterministic_isochrone/out/isochrone_mu2.0_taua2.0_delta1.0_phase{:.2f}.dat".format(phase))
    ...
    x, y = np.meshgrid(np.linspace(-5, 1, 40), np.linspace(0, 10, 20))
    dv = mu - x - y
    da = -y/tau_a
